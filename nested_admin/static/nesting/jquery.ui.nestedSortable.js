    ...
    $.widget("ui.nestedSortable", $.ui.sortable, {
        ...
        _createWidget: function(options, element) {
            var $element = $( element || this.defaultElement || this ),
                dataOptions = $element.data('sortableOptions');
            element = $element[0];
            if (dataOptions) {
                options = $.extend({}, options, dataOptions);
            }
            return $.ui.sortable.prototype._createWidget.call(this, options, element);
        },
        ...
        _contactContainers: function _contactContainers(event) {
            ...
            $.ui.sortable.prototype._contactContainers.call(this, event);
        },
