# -*- coding: utf-8 -*-
#
# django-nested-admin documentation build configuration file, created by
# sphinx-quickstart on Fri Jun  5 22:25:41 2015.
#
...
texinfo_documents = [
  (master_doc, 'django-nested-admin', 'django-nested-admin Documentation',
   author, 'django-nested-admin',
   'django-nested-admin is a project that makes it possible to nest inlines '
   'in the Django admin, with drag-and-drop sort.'
   'Miscellaneous'),
]
